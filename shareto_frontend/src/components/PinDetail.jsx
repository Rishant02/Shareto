    ...
    return (
        <>
            <div className='flex xl:flex-row flex-col m-auto bg-white' style={{ maxWidth: '1500px', borderRadius: '32px' }}>
                ...
                <div className="w-full p-5 flex-2 xl:min-w-620">
                    <div className="flex items-center justify-between">
                        ...
                        <a
                            ...
                            target='_blank'
                            rel='noreferrer'
                            className='border-2 p-2 font-semibold rounded-xl hover:bg-gray-200'
                        >
                    ...
                    <div>
                        ...
                        <p className='mt-3 font-serif'>{pinDetail?.about}</p>
                    </div>
                    <Link to={`/user-profile/${pinDetail?.postedBy?._id}`} className='flex gap-2 mt-5 items-center rounded-lg'>
                        <img src={pinDetail?.postedBy?.image} referrerPolicy='no-referrer' alt="user-profile" className='w-10 h-10 rounded-full' />
                        <p className='font-bold'>{pinDetail?.postedBy?.userName}</p>
                    </Link>
                    <h2 className='mt-5 text-2xl break-words'>Comments</h2>
